...
public class DBProvider {
    ...
    public Product getProduct(int id) throws Exception {
        ...
        Cursor c = db.query(DBHelper.TABLE_PRODUCT, null, selection, selectionArgs, null, null, null);
        if (c.moveToFirst()) {
    ...
    public List<Product> getRecentViewedProducts() {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        Cursor c = db.query(DBHelper.TABLE_RECENT_VIEWED_PRODUCT, null, null, null, null, null, null);
